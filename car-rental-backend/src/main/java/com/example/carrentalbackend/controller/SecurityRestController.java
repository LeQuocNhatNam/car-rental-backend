...
import com.example.carrentalbackend.security_authentication.payload.reponse.JwtResponse;
    ...
    public ResponseEntity<JwtResponse> authenticateUser(@Valid @RequestBody LoginRequest loginRequest) {
        ...
        return ResponseEntity.ok(
                new JwtResponse(
                        ...
                        iAccountService.findAccountByUsername(loginRequest.getUsername()).getUsername(),
                        roles)
        );
    }
